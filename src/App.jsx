      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/:slug" element={
            ...
            <Route path="expedientes/:expedienteId" element={<ProtectedRoute user={session}><GestoriaBlockGuard user={session}><Expedientes user={session} /></GestoriaBlockGuard></ProtectedRoute>} />
